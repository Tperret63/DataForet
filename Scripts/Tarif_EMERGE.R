#' Fonction qui calcule le volume total d'un arbre selon le tarif de cubage du projet EMERGE
#'
#' @description Prend en entrée un data frame avec des mesures par arbre de hauteur totale (m) et circonférence (cm) et selon l'essence identifiée par le code IFN
#'
...
Tarif_EMERGE <- function(df, Hauteur, Circ130){
  load("data/VolEmerge.rda")
  load("data/CodesEssIFN.rda")
